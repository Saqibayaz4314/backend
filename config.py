...
class Settings(BaseSettings):
    ...
    x_bearer_token: Optional[str] = Field(None, alias="X_BEARER_TOKEN")
    x_api_key: Optional[str] = Field(None, alias="X_API_KEY")
    
    # ─────────────────────────────────────────────────────────────────────
    # X (Twitter) API Configuration (Optional)
    # ─────────────────────────────────────────────────────────────────────
    x_api_key: Optional[str] = Field(None, alias="X_API_KEY")
    x_api_secret: Optional[str] = Field(None, alias="X_API_SECRET")
    x_bearer_token: Optional[str] = Field(None, alias="X_BEARER_TOKEN")
    x_access_token: Optional[str] = Field(None, alias="X_ACCESS_TOKEN")
    x_access_token_secret: Optional[str] = Field(None, alias="X_ACCESS_TOKEN_SECRET")
...
def validate_environment() -> dict:
    ...
    status = {
        ...
        "api_keys": {
            ...
            "google_maps": "[OK] Configured" if settings.google_maps_api_key else "[!] Not configured (using mock)",
    ...
    if not settings.google_maps_api_key:
        status["warnings"].append("Google Maps API key not set - will use mock traffic data")
    ...
    if settings.production_mode and not settings.google_maps_api_key:
        status["errors"].append("Production mode requires Google Maps API key")
...
------------------------------------------------------------------------
  API KEYS:
    ...
    - Google Maps: {status['api_keys']['google_maps']}
